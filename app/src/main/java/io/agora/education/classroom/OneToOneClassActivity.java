...
public class OneToOneClassActivity extends BaseClassActivity implements OneToOneClassContext.OneToOneClassEventListener {
    ...
    protected void initView() {
        ...
        video_student.setOnClickAudioListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OneToOneClassActivity.this.muteLocalAudio(!video_student.isAudioMuted());
            }
        });
        video_student.setOnClickVideoListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OneToOneClassActivity.this.muteLocalVideo(!video_student.isVideoMuted());
            }
        });
    }
